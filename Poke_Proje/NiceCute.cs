                ...
                switch (selected)
                {
                    case 0:
                        ...
                        while (loop)
                        {
                            ...
                            char cate = Console.ReadKey(true).KeyChar;
                            ...
                            {
                                case '1':
                                    Chill chill = new Chill(poke, "", 5, 10, 10, 10);
                                    Center.AddPokemon(chill);
                                    break;
                                case '2':
                                    Dramatic drama = new Dramatic(poke, "", 5, 10, 10, 10);
                                    Center.AddPokemon(drama);
                                    break;
                                case '3':
                                    Chaotic choas = new Chaotic(poke, "", 5, 10, 10, 10);
                                    Center.AddPokemon(choas);
                                    break;
                                case '4':
                                    Sneaky sssnake = new Sneaky(poke, "", 5, 10, 10, 10);
